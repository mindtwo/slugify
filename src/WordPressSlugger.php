...
class WordPressSlugger implements SluggerInterface {
    ...
    public function generate( $string ) {
        return $this->sanitize_title_with_dashes( $this->remove_accents( $string ) );
    }
     ...
     */
    protected function sanitize_title_with_dashes( $title, $raw_title = '', $context = 'display' ) {
